             ...
             <div class="row justify-content-between">
                 <div class="col-xl-3 col-lg-4 col-sm-6">
                     <div class="about-txt">
                         <h3>About Us</h3>
                         <p>
                             Explore BodhiWheeler, your reliable choice for wheelchair transport services in Singapore
                             since 2014. We are committed to surpassing your transportation expectations with a focus on
                             excellence.</p>
                         <ul>
