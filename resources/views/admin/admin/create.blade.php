        ...
        <div class="col-12">
            <div class="card">
                <div class="border-bottom title-part-padding">
                    ...
                    <h6 class="card-subtitle">Password will be generated by the system and notify the admin through email.</h6>
                </div>
                <div class="card-body">
                    {{Form::open(['route'=>'admin.admin.store', 'class'=>'form-horizontal', 'files'=>true])}}
