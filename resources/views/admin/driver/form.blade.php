...
<div class="mb-3 row {{ $errors->has('status') ? 'has-danger' : '' }}">
    ...
    <div class="col-sm-9">
        ...
        {{ Form::checkbox('status', 'active', isset($driver) && $driver->status === 'active', ['data-toggle'=>'toggle','data-on'=>'Active','data-off'=>'Inactive','data-onstyle'=>'success','data-offstyle'=>'danger','data-size'=>'sm','data-width'=>'100']) }}
